<%@ Page Title="Modificar Medico" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wf_Medicos_Modificar.aspx.cs" Inherits="Clinica.wf_Medicos_Modificar" %>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-9 col-sm-4 col-md-3 col-lg-2">
                <asp:TextBox ID="tb_cedula" runat="server" MaxLength="16" CssClass="form-control" Enabled="false"></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <asp:TextBox ID="tb_direccion" runat="server" TextMode="MultiLine" MaxLength="150" CssClass="form-control" Enabled="false"></asp:TextBox>
        ...
        <div class="row">
            <div class="col-md-3 col-md-offset-2">
                <asp:Button ID="btn_Modificar" runat="server" Text="Modificar" Enabled="false" 
                    CssClass="btn btn-primary" onclick="btn_Modificar_Click"/>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-11 col-md-11 col-lg-11">
                    <div class="table-responsive">
                        <asp:GridView ID="gv_Medicos" AutoGenerateSelectButton="true" 
                            DataKeyNames="NroCedula" runat="server" BackColor="White" 
                            BorderColor="#999999" BorderStyle="None" BorderWidth="1px" 
                            CellPadding="3" CssClass="table" PageSize="10"
                            GridLines="Vertical" AllowPaging="true" OnPageIndexChanging="gv_Medicos_PageIndexChanging"
                            onselectedindexchanged="gv_Medicos_SelectedIndexChanged" 
                            ...
                            <Columns>
                                <asp:BoundField DataField = "NombreCompleto" HeaderText="Nombre del medico" />
                            </Columns>
